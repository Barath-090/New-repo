    ...
    <>
      ...
      <section className="px-10 py-8 bg-cover bg-center min-h-screen mt-16"style={{ backgroundImage: 'url("https://img.freepik.com/free-photo/indoor-plants-studio_23-2151022069.jpg?w=1380&t=st=1722232114~exp=1722232714~hmac=7ae2ce447a50a8e0084a6ff59a8b1bb8139e6eface0899464e5d11cd29a82727")' }}>
        <div className="flex justify-between items-center px-10 mb-10">
          <span className="font-bold text-5xl text-white">All Tasks</span>
          <button
            onClick={() => setModalVisible(true)}
            className="hover:bg-[#58554e] text-black text-4xl border border-gray-600 rounded-full p-2"
          >
            <MdCreateNewFolder />
          </button>
        </div>
        {isTaskLoading ? (
          ...
          <p className="text-white text-center text-4xl font-bold my-negative-4"> 
